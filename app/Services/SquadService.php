...
class SquadService
{
    ...
    /**
     * Calculate and update player statistics from match data
     */
    public function updatePlayerStatistics(Team $team): void
    {
    ...
    /**
     * Calculate player statistics (placeholder implementation)
     */
    private function calculatePlayerStats(Player $player): array
    {
        // This is a placeholder - in reality, you'd calculate from match data
        // You might have player_match_stats table or similar
        return [
            'goals' => rand(0, 15),
            'assists' => rand(0, 10),
            'appearances' => rand(10, 25),
            'minutes' => rand(500, 2000),
     ...
     */
    public function getTopPerformers(Team $team): array
    {
        return [
            'top_scorers' => $team->players()
                                ->where('goals', '>', 0)
                                ->orderBy('goals', 'desc')
                                ->limit(5)
                                ->get(),
            'top_assists' => $team->players()
                               ->where('assists', '>', 0)
                               ->orderBy('assists', 'desc')
                               ->limit(5)
                               ->get(),
            'most_appearances' => $team->players()
                                    ->where('appearances', '>', 0)
